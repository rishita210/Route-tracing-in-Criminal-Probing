...
def find_route(folium_map, source, destination, avoid_low_accessibility, avoid_traffic, avoid_low_walkability,
    ...
    source_coords = find_coordinates_of_place(source)
